...
<body>
                ...
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="TugasDanFungsi.php" class="dropdown-item active">Tugas dan fungsi</a>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mb-5">Tugas Dan Fungsi</h1>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <h1 class="text-primary text-uppercase font-weight-bold">Tugas DAN FUNGSI</h1>
                        <li><h6></i>1. Menyelenggarakan urusan pemerintah umum;</h6>
                        <li><h6></i>2. Mengoordinasikan kegiatan pemberdayaan masyarakat;</h6>
                        <li><h6></i>3. Mengoordinasikan upaya penyelenggaraan ketentraman dan ketertiban umum;</h6>
                        <li><h6></i>4. mengoordinasikan penerapan dan penegakan Peraturan Daerah dan Peraturan Walikota;</h6>
                        <li><h6></i>5. memfasilitasi penyelenggaraan Perpustakaan di Kecamatan;</h6>
                        <li><h6></i>6. mengoordinasikan pemeliharaan prasarana dan sarana pelayanan umum;</h6>
                        <li><h6></i>7. mengoordinasikan penyelenggaraan kegiatan pemerintahan yang dilakukan oleh Perangkat Daerah di tingkat Kecamatan ;</h6> 
                        <li><h6></i>8. membina dan mengawasi penyelenggaraan kegiatan Kelurahan ;</h6>   
                        <li><h6></i>9. melaksanakan urusan pemerintahan yang menjadi kewenangan Daerah yang tidak dilaksan akan oleh unit kerja Pemerintahan Daerah yang ada di Kecamatan ; dan</h6>
                        <li><h6></i>10. melaksanakan tugas lain yang diperintahkan oleh peraturan perundang- Udangan.</h6>       
                    </ul>
                </div>    
            </div>
        </div>
