                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <th scope="col"><?php echo $d['nip']; ?></th>
                                  <th scope="col"><?php echo $d['username']; ?></th>
                                  <th scope="col"><?php echo $d['password']; ?></th>
                                  <th scope="col"><?php echo $d['jabatan']; ?></th>
                                  <th>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $d['nip']; ?>">Edit</button>
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="delete.php?id=<?php echo $d['nip']; ?>">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Foto Sturktur</h6> 
                                    <form method="POST" action="gambar.php" enctype="multipart/form-data">
                            <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#foto">
                                    Upload Sturktur
                                    </button>
                                    <!-- Modal -->
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <th>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $d['nip']; ?>">Edit</button>
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="deletegambar.php?id=<?php echo $d['id']; ?>">
                                <button class="btn btn-danger"><i class="mdi mdi-close"></i>Hapus</button>
                                </a>
                              </th>
                                </tr>
