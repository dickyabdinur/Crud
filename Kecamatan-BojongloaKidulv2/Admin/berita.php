                        ...
                        <div class="bg-light text-center rounded p-4">
                            ...
                            <!-- Button trigger modal -->
                                    ...
                                    <h5>Judul</h5>
                                        ...
                                        <br>
                                    <h5>Deksripsi</h5>
                                        <textarea name="deskripsi" class="form-control" cols="40" rows="5" minlength="10" maxlength="100" required="required"/> </textarea>
                                        <br>
                                    <h5>TANGGAL</h5>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                while($d = mysqli_fetch_array($data)){
                                    ?>
                                <tr>
                                  <th scope="col"><img src="file/<?php echo $d['file'] ?>" width="35" height="40"></th>
                                  <th scope="col"><?php echo $d['judul']; ?></th>
                                  <th scope="col"><?php echo $d['deskripsi']; ?></th>
                                  <th scope="col"><?php echo $d['tgl']; ?></th>
                                ...
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="deleteberita.php?id=<?php echo $d['id']; ?>">
                                ...
                                <div class="modal fade" id="myModal<?php echo $d['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form role="form" action="updateberita.php" method="post" enctype="multipart/form-data">>
                                        <?php
                                        $id = $d['id']; 
                                        $query_edit = mysqli_query($conn,"SELECT * FROM berita WHERE id='$id'");
                                        //$result = mysqli_query($conn, $query);
                                        while ($row = mysqli_fetch_array($query_edit)) {  
                                        ?>
                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                        <font><h5>Gambar</h5></font>
                                            <img src="file/<?php echo $d['file'] ?>" width="150px" height="120px" /></br>
                                            <input type="checkbox" name="ubah_foto" value="true"><font style="color: red">Gambar Tidak Bisa Diubah</font><br>
                                            <input name="gambar" id="gambar" type="file" class="form-control" disabled/>
                                        <font><h5>JUDUL</h5></font>
                                            <input type="text" class="form-control" name="judul" value="<?php echo $row['judul']; ?>">
                                        <font><h5>DESKRIPSI</h5></font>
                                            <input type="text" class="form-control" name="deskripsi" value="<?php echo $row['deskripsi']; ?>">
                                        <font><h5>TANGGAL</h5></font>
                                            <input type="date" class="form-control" name="tgl" value="<?php echo $row['tgl']; ?>">
                                        <font><h5>LINK</h5></font>
