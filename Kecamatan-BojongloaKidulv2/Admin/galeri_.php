            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Input Data</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="berita_.php" class="dropdown-item">Berita</a>
                            <a href="galeri_.php" class="dropdown-item">Galeri</a>
                        </div>
                </div>
            </nav>
        </div>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <i class="fa fa-user"></i><span class="d-none d-lg-inline-flex">Pegawai</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    ?>
                                <h6 class="mb-0"><?php echo $jumlah_barang; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Data Galeri</h6> 
                                    <form method="post" action="savegaleri.php" enctype="multipart/form-data">
                            <!-- Button trigger modal -->
                                    ...
                                    <h5 class="left">Judul</h5>
                                        ...
                                        <br>
                                    <h5 class="left">Deksripsi</h5>
                                        <textarea name="deskripsi" class="form-control" cols="40" rows="5" required>
                                       </textarea>
                                        <br>
                                          </div>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <th>
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="deletegaleri.php?id=<?php echo $d['id']; ?>">
