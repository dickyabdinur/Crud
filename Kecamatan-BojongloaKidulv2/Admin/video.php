                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="video.php" class="dropdown-item active">Video</a>
                        ...
                        <div class="bg-light text-center rounded p-4">
                            ...
                            <!-- Button trigger modal -->
                                    ...
                                    <h5 class="left">Judul</h5>
                                        ...
                                        <br>
                                    <h5 class="left">Tanggal Pembuatan Video</h5>
                                        <input type="date" name="tgl" class="form-control" required>
                                        <br>
                                    <h5 class="left">Link Youtube</h5>
                                        <input type="text" name="link" class="form-control" required>
                                        <p style="color: red">Harus Ada Text (embed)<br>
                                        Conoth Link = https://www.youtube.com/embed/_twe1fb_YOg</p>
                                    <br>
                                          </div>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                include '../config/config.php';
                                $no = 1;
                                $data = mysqli_query($conn,"SELECT * from yt");
                                ...
                                <tr>
                                  ...
                                  <th>
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="deletevideo.php?id=<?php echo $d['id']; ?>">
