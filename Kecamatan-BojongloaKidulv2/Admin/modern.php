                        ...
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Modern</h6> 
                                    <form method="POST" action="modern_.php">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Tambah Modern</h5>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                include '../config/config.php';
                                $no = 1;
                                $data = mysqli_query($conn,"SELECT * from modern");
                                ...
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="deletemodern.php?id=<?php echo $d['id']; ?>">
                                ...
                                <div class="modal fade" id="myModal<?php echo $d['nama']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form role="form" action="updatemodern.php" method="post">
                                        <?php
                                        $nama = $d['nama']; 
                                        $query_edit = mysqli_query($conn,"SELECT * FROM modern WHERE nama='$nama'");
