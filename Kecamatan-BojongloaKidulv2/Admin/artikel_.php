                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="artikel_.php" class="dropdown-item active">Artikel</a>
                        </div>
                    <div class="nav-item dropdown">
                                    ...
                                    <div class="modal fade" id="artikel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog">
                                        ...
                                        <h5 class="left">DESKRIPSI</h5>
                                            ...
                                            <br>
                                        <h5 class="left">NAMA ARTIKEL</h5>
                                            <input type="text" class="form-control" name="artikel">
                                            <br>
                                        <h5 class="left">LINK ARTIKEL</h5>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <th scope="col"><?php echo $d['artikel']; ?></th>
                                  <th scope="col"><?php echo $d['link']; ?></th>
                                  <th>
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="deleteartikel.php?id=<?php echo $d['id']; ?>">
