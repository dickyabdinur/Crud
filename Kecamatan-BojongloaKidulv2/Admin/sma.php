                        ...
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">SMA</h6> 
                                    <form method="POST" action="sma_.php">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Tambah SMA</h5>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                include '../config/config.php';
                                $no = 1;
                                $data = mysqli_query($conn,"SELECT * from sma");
                                ...
                                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="deletesma.php?id=<?php echo $d['id']; ?>">
                                ...
                                <div class="modal fade" id="myModal<?php echo $d['nama']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form role="form" action="updatesma.php" method="post">
                                        <?php
                                        $nama = $d['nama']; 
                                        $query_edit = mysqli_query($conn,"SELECT * FROM sma WHERE nama='$nama'");
