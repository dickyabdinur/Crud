   ...
   <!-- Topbar Start -->
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="dropdown-menu rounded-0 m-0">
                            <a href="Galeri.php" class="dropdown-item active">Galeri Foto</a>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mb-5">Galeri Foto</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <h6 class="text-primary text-uppercase font-weight-bold">Galeri Kecamatan</h6>
                <h1 class="mb-2">Kecamatan Bojongloa Kidul</h1>
            </div>
            <div class="row">
                                <?php 
                                include 'config/config.php';
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="team card position-relative overflow-hidden border-0 mb-5">
                        <img class="card-img-top" style="height: 300px; border:solid #000; overflow-y:hidden; width: 520px" src="Admin/file/<?php echo $d['file'] ?>">
