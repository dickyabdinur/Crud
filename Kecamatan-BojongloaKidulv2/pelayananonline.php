...
<body>
                ...
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="pelayananonline.php" class="dropdown-item active">Informasi Pelayanan Online</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Informasi Pelayanan Online</h1>
        </div>
    </div>
    <!-- Header End -->
    <!-- About Start -->
    <div class="container-fluid py-5">
        <?php 
                                include 'config/config.php';
                                $no = 1;
                                $data = mysqli_query($conn,"SELECT * from online ORDER BY id DESC");
                                while($d = mysqli_fetch_array($data)){
                                   ?>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 pb-4 pb-lg-0">
                    <img class="img-fluid w-100" src="Admin/file/<?php echo $d['gambar']; ?>" alt=""style="width: 700px; height: 300px;">
                </div>
                <br>
                <div class="col-lg-7">
                    <h3 class="text-primary text-uppercase font-weight-bold"><?php echo $d['judul']; ?></h3>
                    <p class="mb-4"><?php echo $d['deskripsi']; ?></p>
                    <a href="<?php echo $d['link']; ?>"><p class="mb-4">SUMBER : <?php echo $d['link']; ?></p></a>
                </div>
            </div>
        </div>
        <?php } ?>
