   ...
   <!-- Topbar Start -->
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Galeri</a>
                    <div class="dropdown-menu rounded-0 m-0">
                            <a href="Galeri.php" class="dropdown-item">Galeri Foto</a>
                            <a href="Ggaleri.php" class="dropdown-item active">Galeri Video</a>
                    </div>
                    </div>
                </div>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mb-5">Galeri Video</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <h6 class="text-primary text-uppercase font-weight-bold">Galeri Video</h6>
                <h1 class="mb-2">Selamat Menonton</h1>
            </div>
            <div class="row">
                                <?php 
                                include 'config/config.php';
                                $no = 1;
                                $data = mysqli_query($conn,"SELECT * from yt ORDER BY id DESC");
                                  while($d = mysqli_fetch_array($data)){
                                    ?>
                <div class="col-lg-6 col-md-12">
                    <div class="team card position-relative overflow-hidden border-0 mb-5">
                        <iframe style="height: 300px; border:solid #000; overflow-y:hidden; width: 520px" src="<?php echo $d['link']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe>
                        <div class="card-body text-center p-4">
                            <div class="d-flex flex-column justify-content-center bg-secondary">
                                <h5 class="font-weight-bold"><?php echo $d['judul']; ?></h5>
