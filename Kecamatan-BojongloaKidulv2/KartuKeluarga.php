                ...
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="KartuKeluarga.php" class="dropdown-item active">Kartu Keluarga</a>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid w-100" src="img/kk.jpg" alt=""style="width: 500px;height: 300px;">
                </div>
                <div class="col-lg-7">
                    <h6 class="text-primary text-uppercase font-weight-bold">Kartu Keluarga</h6>
                    <h1 class="mb-4">apa itu kartu keluarga</h1>
                    <p class="mb-4"><h5> adalah kartu identitas keluarga yang memuat data tentang susunan, hubungan dan jumlah anggota keluarga. KK wajib dimiliki oleh setiap keluarga.</h5></p>
                    <div class="d-flex align-items-center pt-2"></div>
                    <ul class="list-inline">
                        <h1 class="mb-4">Persyaratan Penerbitan Kartu keluarga (KK)</h1>
                        <ol>
                        <li><h5>Format KK yang Sudah Diisi Lengkap di TTD</h5></li>
                        <li><h5>KK Lama Dibawa</h5></li>
                        <li><h5>KK Hilang, membawa Surat Keterangan Hilang Kepolisian</h5></li>
                        <li><h5>KK Pindah membawa Surat Pindah Datang</h5></li>
                        <li><h5>FC. Surat Nikah/Akta Nikah</h5></li>
                        <li><h5>FC. Surat Kelahiran/ Akta Kelahiran</h5></li>
                        <li><h5>FC. Ijazah Terakhir</h5></li>
                        <li><h5>FC. Akta Perceraian</h5></li>
                        </ol>   
                    </ul>
                    <p><h5> penyelesaian : 8 Hari kerja</h5></p>
                    <p><h5> Biaya: 100% Gratis</h5></p>
