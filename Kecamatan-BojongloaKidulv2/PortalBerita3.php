                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="position-relative">
                            <img class="img-fluid w-100" src="img/berita7.png" alt="">
                        ...
                        <div class="bg-secondary mb-3" style="padding: 30px;">
                            ...
                            <p>Giat Camat Bojongloa Kidul melaksanakan Panen Sosin,Mentimun & Terong di Buruan SAE Lumbung Tani Kel.Cibaduyut & Panen Cabe rawit, Kangkung di Bursa Karya Bersama Kel.Cibkid serta melaksanakan penanaman Bibit Bwg Merah</p>
                            <a class="border-bottom border-primary text-uppercase text-decoration-none" href="https://www.instagram.com/p/CkLCksFBd1R/">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="position-relative">
                            <img class="img-fluid w-100" src="img/berita8.png" alt="">
                            <div class="position-absolute bg-primary d-flex flex-column align-items-center justify-content-center rounded-circle"
                                style="width: 60px; height: 60px; bottom: -30px; right: 30px;">
                                <h4 class="font-weight-bold mb-n1">26</h4>
                                <small class="text-white text-uppercase">Okt</small>
                        ...
                        <div class="bg-secondary mb-3" style="padding: 30px;">
                            ...
                            <h4 class="font-weight-bold mb-3">Berita harian</h4>
                            <p>Giat Bandung Menanam Jilid IV TK. Kecamatan Bojongloa Kidul Sekaligus Menebar Bibit Ikan Lele dan Bibit Bawang Merah Rabu</p>
                            <a class="border-bottom border-primary text-uppercase text-decoration-none" href="https://www.instagram.com/p/CkLBkZjhchE/">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="position-relative">
                            <img class="img-fluid w-100" src="img/berita9.png" alt="">
                            <div class="position-absolute bg-primary d-flex flex-column align-items-center justify-content-center rounded-circle"
                                style="width: 60px; height: 60px; bottom: -30px; right: 30px;">
                                <h4 class="font-weight-bold mb-n1">19</h4>
                                <small class="text-white text-uppercase">Okt</small>
                            </div>
                        </div>
                        <div class="bg-secondary mb-3" style="padding: 30px;">
                            ...
                            <h4 class="font-weight-bold mb-3">Berita harian</h4>
                            <p>Giat Bina Wilayah Forum WPA Kecamatan ex-Wilayah Tegalega yang diselenggarakan di aula kantor Kecamatan Babakan Ciparay</p>
                            <a class="border-bottom border-primary text-uppercase text-decoration-none" href="https://www.instagram.com/p/Cj5SJ7Chbx_/">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <nav aria-label="Page navigation">
                          <ul class="pagination pagination-lg justify-content-center mb-0">
                            <li class="page-item">
                              <a class="page-link" href="PortalBerita2.html" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                                <span class="sr-only">Previous</span>
                              </a>
                            </li>
                            <li class="page-item"><a class="page-link" href="PortalBerita1.html">1</a></li>
                            <li class="page-item"><a class="page-link" href="PortalBerita2.html">2</a></li>
                            <li class="page-item active"><a class="page-link" href="PortalBerita3.html">3</a></li>
                            <li class="page-item disabled">
                              <a class="page-link" href="PortalBerita.html" aria-label="Next">
